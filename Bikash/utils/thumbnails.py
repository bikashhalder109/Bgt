...
from Bikash.assets import thumbs, colors
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"Bikash/assets/{images}.png")
        ...
        font = ImageFont.truetype("Bikash/assets/font2.ttf", 45)
        ImageFont.truetype("Bikash/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Bikash/assets/font2.ttf", 30)
        ImageFont.truetype("Bikash/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=32)
        try:
            draw.text(
                (450, 35),
                f"BGT STARTED PLAYING",
                fill="white",
                stroke_width=1,
                stroke_fill="white",
                font=font,
